        ...
        <main>
            ...
            <a href="#">
              ...
              <div className="item-text-section">
                ...
                <p className="item-description">
                  ...
                  our latest attempt of adding value and making an impact to the
            ...
            <a href="#">
              ...
              <div className="item-text-section">
                ...
                <p className="item-description">
                  ...
                  sandwitched by good food and tea (on a lighter note, need to
                  investigate the tactics behind the 5-star hotels...
                </p>
              </div>
            </a>
          </article>
          <article className="items">
            <a href="#">
              ...
              <div className="item-text-section">
                <h3 className="item-title">
                  Building the University for 21st Century...
                </h3>
                <div className="author-date-section">
                  <span className="item-author">Arman Ahmed</span>
                ...
                <p className="item-description">
                  ...
                  and a little worried. And it happened...
                </p>
              </div>
            </a>
          </article>
          <article className="items">
            <a href="#">
              ...
              <div className="item-text-section">
                ...
                <p className="item-description">
                  The term Income Share Agreement has been around for a long
          ...
          <article className="items">
            <a href="#">
              ...
              <div className="item-text-section">
                <h3 className="item-title">
                  Your Guide to Edyoda Admission Test
                </h3>
                <div className="author-date-section">
                  <span className="item-author">Edyoda</span>
                ...
                <p className="item-description">
                  All about Edyoda admissions test and how to avail the
                  scholarships upto INR 2,50,000...
                  <br />
                  <br />
                  <br />
                </p>
            ...
            <a href="#">
              ...
              <div className="item-text-section">
                ...
                <p className="item-description">
                  ...
                  zekeLabs gave me a unique opportunity...
                </p>
              </div>
            </a>
          </article>
